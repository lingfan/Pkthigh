...
{
    unsafe class Module_Network_PBSocket_PBPacket_1_PBRespAccountMobileSecret_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Module.Network.PBSocket.PBPacket<pbcmd.PBRespAccountMobileSecret>);
            args = new Type[]{};
        ...
        static StackObject* get_PBBody_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Module.Network.PBSocket.PBPacket<pbcmd.PBRespAccountMobileSecret> instance_of_this_method = (Module.Network.PBSocket.PBPacket<pbcmd.PBRespAccountMobileSecret>)typeof(Module.Network.PBSocket.PBPacket<pbcmd.PBRespAccountMobileSecret>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
